 ...
 * @author yuhuangbin
 */
public class MmtxFeignBlockingLoadBalancerClient implements Client {

	private static final Log LOG = LogFactory
			.getLog(MmtxFeignBlockingLoadBalancerClient.class);

	private final Client delegate;

	private final BlockingLoadBalancerClient loadBalancerClient;

	MmtxFeignBlockingLoadBalancerClient(Client delegate,
