 ...
 * @author xiaojing
 */
public class MmtxLoadBalancerFeignClient extends LoadBalancerFeignClient {

	private static final int MAP_SIZE = 16;

	private final BeanFactory beanFactory;

	MmtxLoadBalancerFeignClient(Client delegate,
	...
	private static Client wrap(Client delegate, BeanFactory beanFactory) {
		return (Client) new MmtxFeignObjectWrapper(beanFactory).wrap(delegate);
	}
